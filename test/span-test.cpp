...
TEST_CASE("Iterator", "[Span]")
{
    SECTION("Difference")
    {
        i32 array[] = {1, 2, 3, 4, 5};
        Span<i32> span(array);
        Span<i32>::iterator it1 = span.begin();
        Span<i32>::iterator it2 = span.end();
        REQUIRE(it2 - it1 == 5);
    }
    SECTION("Increment")
    {
        i32 array[] = {1, 2, 3};
        Span<i32> span(array);
        Span<i32>::iterator it = span.begin();
        REQUIRE(*it == 1);
        ++it;
        REQUIRE(*it == 2);
        ++it;
    ...
    SECTION("Add")
    {
        ...
        Span<i32>::iterator it2 = span.begin();
    ...
    SECTION("For loop")
    {
        ...
        Span<i32> span(array);
        i32 sum = 0;
        for (Span<i32>::iterator it = span.begin(); it != span.end(); ++it)
        {
            sum += *it;
        }
        REQUIRE(sum == 6);
...
TEST_CASE("Const iterator", "[Span]")
{
    SECTION("Difference")
    {
        i32 array[] = {1, 2, 3};
        Span<i32> span(array);
        Span<i32>::const_iterator it1 = span.cbegin();
        Span<i32>::const_iterator it2 = span.cend();
        REQUIRE(it2 - it1 == 3);
    }
    SECTION("Increment")
    {
        i32 array[] = {1, 2, 3};
        Span<i32> span(array);
        Span<i32>::const_iterator it = span.cbegin();
        REQUIRE(*it == 1);
        ++it;
        REQUIRE(*it == 2);
        ++it;
    ...
    SECTION("Post increment")
    {
        ...
        it++;
        REQUIRE(*it == 3);
        Span<i32>::const_iterator prev = it++;
        REQUIRE(it - prev == 1);
        REQUIRE(it == span.cend());
    }
    SECTION("Decrement")
    {
        i32 array[] = {1, 2, 3};
        Span<i32> span(array);
        Span<i32>::const_iterator it = span.cend();
        --it;
        REQUIRE(*it == 3);
        --it;
        REQUIRE(*it == 2);
    ...
    SECTION("Add")
    {
        ...
        Span<i32>::const_iterator it2 = span.cbegin();
    ...
    SECTION("For loop")
    {
        ...
        Span<i32> span(array);
        i32 sum = 0;
        for (Span<i32>::const_iterator it = span.cbegin(); it != span.cend(); ++it)
        {
            sum += *it;
        }
        REQUIRE(sum == 6);
